...
workflow CRISPRSEQ_SCREENING {
    ...
    if (params.crisprcleanr) {
        ...
        CRISPRCLEANR_NORMALIZE.out.norm_count_file
            .map { it ->
                it[1]
            }
            .set { ch_counts }
    ...
    if (params.contrasts) {
        ...
        if (params.bagel2) {
            ...
            ch_bagel_pr = BAGEL2_BF.out.bf
                .combine(ch_bagel_reference_essentials)
